...
begin
    ...
    reservoir_param_keys(::Type{ES2N}) =
        (:input_matrix, :reservoir_matrix, :orthogonal_matrix)
    reservoir_param_keys(::Type{EuSN}) = (:input_matrix, :reservoir_matrix)
    reservoir_param_keys(::Type{ResESN}) =
        (:input_matrix, :reservoir_matrix, :orthogonal_matrix)
    ...
    function test_esn_family_contract(::Type{RMNESN})
        ...
        @testset "RMNESN: optional memory and nonlinear biases are parameterized" begin
            ...
            model = build_model(
                ...
                use_bias = True(),
                init_bias = _O32,
                extra = (use_memory_bias = True(), init_memory_bias = _O32),
            )
