...
include("models/esn_inputdelay.jl")
include("models/esn_fulldelay.jl")
...
export ES2N, ESN, EuSN, DeepESN, DelayESN, HybridESN, EIESN, AdditiveEIESN, InputDelayESN, FullDelayESN
export NGRC
#ext
