...
export rand_sparse, delay_line, delay_line_backward_reservoir
...
for initializer in (:rand_sparse, :delay_line, :delay_line_backward_reservoir, :scaled_rand, :weighted_init, :sparse_layer, :informed_layer, :bernoulli_sample_layer, :irrational_sample_layer)
